...
void main()
{
	...
	cprintf("Enter your desired corresponding number");gotoxy(22,19);textcolor(10);
	cprintf("1.Add new Element Information");gotoxy(22,21);
	cprintf("2.Explore(born to explore)");gotoxy(22,23);
	cprintf("3.Get out of here");gotoxy(22,25);
	...
	switch(d)
	{
		...
		case '3':
			...
			cprintf("THANK U But not really");gotoxy(30,26);
