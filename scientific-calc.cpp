...
int c; 
cout<<endl; 
cout<<"***** Scientific Calculator *********Please buy a calc instead of using this*********\n"; 
cout<<"---------------------------------------------------\n"; 
...
cout<<"Enter the function that you want to perform(cant belive u r still using it : "; 
cin>>c; 
PI=3.14159265; 
switch(c) 
{ 
...
break; 
default: 
cout<<"Bastard its my humble request, cheak ur input data"<<endl; 
} 
}
